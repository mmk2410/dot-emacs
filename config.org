...
(setq-default global-visual-wrap-prefix-mode t)
...
(with-eval-after-load 'ispell
  ...
  (setq ispell-dictionary "en_GB,de_DE,en_US")
  (ispell-set-spellchecker-params)
  (ispell-hunspell-add-multi-dic "en_GB,de_DE,en_US"))
#+end_src
...
Save bookmarks after every bookmarking action.
...
Adjustments for the Emacs kill-ring.
...
If something doesn't work, it is IMHO quite obvious for me.
...
#+begin_src emacs-lisp
(if on-macos
    (setq mmk2410/frame-font "Maple Mono 14"
          mmk2410/frame-font-present "Maple Mono 16"
          mmk2410/fixed-font-name "Maple Mono"
          mmk2410/fixed-font-height 140
          mmk2410/fixed-font-present-height 160
          mmk2410/variable-font-name "Jost*"
          mmk2410/variable-font-height 160
          mmk2410/variable-font-present-height 180)
    (setq mmk2410/frame-font "Maple Mono 11"
          mmk2410/frame-font-present "Maple Mono 16"
          mmk2410/fixed-font-name "Maple Mono"
...
(defun mmk2410/display-normal-typeface-size ()
  ...
  (set-face-attribute 'variable-pitch nil :family mmk2410/variable-font-name :height mmk2410/variable-font-height :weight 'regular)
...
Ligature support (a try):

#+begin_src emacs-lisp
(use-package ligature
  :config
  ;; Enable the ligature in every possible major mode
  (ligature-set-ligatures
   't
   '("Cl" "al" "cl" "el" "il" "tl" "ul" "xl" "ff" "tt" "all" "ell" "ill" "ull"))
  ;; Enable traditional ligature support in eww-mode, if the
  ;; `variable-pitch' face supports it
  ;; (ligature-set-ligatures 'eww-mode '("ff" "fi" "ffi"))
  ;; Enable all Maple Mono ligatures in programming modes
  (ligature-set-ligatures
   'prog-mode
   '("::" "?." "<#--" ":::" "..<" "<!---->" "?:" ".=" "<->" ":?" "<~"
     "<-->" ":?>" "~>" "->" "<:" "~~" "<-" ":>" "<~>" "-->" ":<" "<~~"
...
(use-package ef-themes
  ...
  :config
  (setq modus-themes-to-toggle '(ef-melissa-light ef-melissa-dark)
        modus-themes-mixed-fonts t
        modus-themes-italic-constructs t
        modus-themes-bold-constructs t
        modus-themes-variable-pitch-ui t
        modus-themes-headings '((0 . (variable-pitch 1.3))
                                (1 . (1.25))
                                (2 . (1.2))
                                (agenda-date . (variable-pitch 1.1))
                                (agenda-structure . (variable-pitch 1.1))
                                (3 . (1.15))
                                (4 . (1.1))
                                (5 . (1.05))
                                (t . t)))
...
On GNOME, hide the window decorations (the header bar takes up an enormous amount of space for doing nothing).
...
(defun mmk2410/org-font-adjust-headlines ()
  ...
  (dolist (face '((org-level-1 . 1.3)
                  ...
                  (org-level-7 . 1.1)
                  (org-level-8 . 1.1)))
    (set-face-attribute (car face) nil :family "Jost*" :weight 'medium :height (cdr face))))
...
[[https://protesilaos.com/emacs/denote][Denote]] is a note taking system and naming scheme by Protesilaos Stavrou.

As of 2026-04-18 I'm in progress of migrating my Org-Roam setup to Denote. Therefore, the configuration below is subject to change.

Regarding file naming schemes and especially tagging, I can recommend the fabulous article [[https://karl-voit.at/managing-digital-photographs/][Managing Digital Files (e.g., Photographs) in Files and Folders]] by Karl Voit.
...
[[https://github.com/namilus/denote-menu][denote-menu]] is tabular view of your notes with some filter capabilities.
...
As of 2026-04-18 I'm gradually switching to Denote. During the next months I will migrate or archive my existing Org Roam notes. Due to missing requirements I already disabled some integrations.
...
Source: [[https://github.com/jacktasia/dumb-jump][GitHub: jacktasia/dumb-jump]]
...
[[https://github.com/svaante/dape][GitHub: svaante/dape]]
...
(use-package eshell
  ...
  (setq eshell-visual-subcommands
        '(("docker" "pull" "build" ("compose" "build"))))
...
Source: [[https://github.com/emacs-elfeed/elfeed][GitHub: emacs-elfeed/elfeed]]
...
Initial draft of integrating =gptel=.
  ...
  (setq gptel-model 'gemma4:e4b
        gptel-backend (gptel-make-ollama "Ollama"
                        ...
                        '((hf.co/unsloth/Apertus-8B-Instruct-2509-GGUF:Q4_K_M
                           :description "Apertus 8B")
                          (gemma4:e4b
                           :description "Gemma 4 equiv. 4B"
                           :capabilities (tool-use))
                          (gemma4:12b
                           :description "Gemma 4 12B"
                           :capabilities (tool-use))
                          (gemma4:26b
                           :description "Gemma 4 26B"
                           :capabilities (tool-use))
                          (gemma3n:e4b
                           :description "Gemma 3n equiv. 4B")
                          (qwen3.5:4b
                           :description "Qwen 3.5 4B"
                           :capabilities (tool-use media)
                           :request-params (:reasoningEffort "none"
                                            :think :json-false
                                            :thinking (:type "disabled" :reasoningEffort "none")))
                          (qwen3.5:9b
...
Initial draft of integrating =agent-shell=.
...
Helpers for working on Qwint.

#+begin_src emacs-lisp
(use-package qwint
  :unless (mmk2410/work)
  :load-path "packages/qwint/"
  :config
  (qwint-init-org-capture-template))
#+end_src
